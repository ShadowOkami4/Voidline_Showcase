    ...
    Rectangle {
        ...
        Row {
            ...
            Text {
                ...
                font.pixelSize: 24
                color: {
                    if (parent.parent.isCharging) return Config.successColor
                    if (parent.parent.isLow) return Config.errorColor
                ...
                text: {
                    let pct = parent.parent.batteryPercent
                    let charging = parent.parent.isCharging
            ...
            Text {
                ...
                text: parent.parent.batteryPercent + "%"
            }
        }
        ...
        MouseArea {
            ...
            hoverEnabled: true
            cursorShape: Qt.PointingHandCursor
            // Could open battery details panel
        }
    }
}